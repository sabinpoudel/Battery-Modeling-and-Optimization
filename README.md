...
The principal scientific question implemented by the notebook is:
...
- $I_{s,k}$ for current;
- $T_{s,k}$ for cell temperature; and
...
- 4,077 fit-eligible trajectories; and
